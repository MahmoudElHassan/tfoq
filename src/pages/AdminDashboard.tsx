...
const titles: Record<string, { title: string; subtitle: string }> = {
  ...
  teachers: { title: "المعلمين والتفويض", subtitle: "إدارة المهام والمواد المكلّفون بها" },
...
const AdminDashboard = () => {
  ...
  const handleExport = () => {
    const overviewSheet = [
      ...
      { المؤشر: "الطلاب", القيمة: 1235, "نسبة النمو": "8.3%" },
      { المؤشر: "أولياء الأمور", القيمة: 978, "نسبة النمو": "15.2%" },
      { المؤشر: "المعلمين", القيمة: 64, "نسبة النمو": "4.1%" },
    ];
    const statsSheet = [
      { المؤشر: "متوسط النقاط العام", القيمة: 78.4 },
      { المؤشر: "الطلاب المرتبطون بأولياء الأمور", القيمة: 892 },
