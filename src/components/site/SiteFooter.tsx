...
const DEFAULT_FOOTER: FooterRow = {
  brand_subtitle: "ثانوية الطلاب",
  about: "منصة تعليمية تفاعلية مخصصة لطلاب المرحلة الثانوية لتعزيز مهاراتهم في اختبارات التحصيلي والقدرات عبر أدوات حديثة وممتعة.",
