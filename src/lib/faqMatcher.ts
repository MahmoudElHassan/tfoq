...
export const GUIDED_TOPICS: GuidedTopic[] = [
  ...
  },
  {
    ...
    icon: "👨‍👩‍👧",
    description: "ربط طالب، متابعة الأبناء",
  ...
  },
  {
    ...
    action: { kind: "ask", label: "اكتب مشكلتك وسأحاول المساعدة", query: "أحتاج مساعدة" },
  },
];
...
export const FALLBACK_FAQS: FaqWithKeywords[] = [
  {
    ...
    answer:
      "منصة تعليمية تفاعلية لطلاب الثانوية تساعد على التحضير لاختباري التحصيلي والقدرات عبر عجلة أسئلة، اختبارات محاكية، وألعاب تعليمية.",
  ...
  },
  {
    ...
    answer:
      "أنشئ حساباً جديداً من صفحة تسجيل الدخول، ثم اختر دورك (طالب / معلم / ولي أمر)، وبعدها يمكنك بدء عجلة الاختبارات أو تصفح الاختبارات المحاكية.",
    keywords: ["تسجيل", "بدء", "انشاء", "حساب", "اشتراك", "دخول"],
  },
  {
    id: "fallback-3",
    question: "هل استخدام المنصة مجاني؟",
    answer: "نعم، المنصة مجانية لجميع طلاب الثانوية في حدود الاستخدام العادل.",
